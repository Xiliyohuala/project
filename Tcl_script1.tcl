...
set_location_assignment PIN_133 -to segcom[5]
set_location_assignment PIN_132 -to segcom[4]
set_location_assignment PIN_129 -to segcom[3]
set_location_assignment PIN_3 -to segcom[2]
set_location_assignment PIN_2 -to segcom[1]
set_location_assignment PIN_1 -to segcom[0]
